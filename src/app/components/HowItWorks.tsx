  ...
  const steps = [
    {
      ...
      description: "La empresa llena el formulario de colaboración indicando sus intereses y disponibilidad.",
      color: "#E8401C",
    },
    {
      number: "02",
      icon: "🤝",
      title: "EZER conecta",
      description: "Nuestro equipo vincula a la empresa con ONGs que mejor se ajustan a su perfil y objetivos.",
      color: "#F5C200",
    },
    {
      number: "03",
      ...
      description: "Se coordina fecha, logística y número de voluntarios para el evento de impacto social.",
      color: "#E8401C",
    },
    {
      number: "04",
